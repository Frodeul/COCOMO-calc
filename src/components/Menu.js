...
export const Menu = () => (
    <div className="list-group" id="list-tab" role="tablist">
        <a className="list-group-item list-group-item-action active" id="list-basic-list"
           data-toggle="list" href="#list-cocomo" role="tab" aria-controls="cocomo"><strong>COCOMO</strong></a>
        <a className="list-group-item list-group-item-action" id="list-basic-list"
        ...
        <a className="list-group-item list-group-item-action" id="list-cocomoII-list"
           data-toggle="list" href="#list-cocomoII" role="tab" aria-controls="cocomoII"><strong>COCOMO II</strong></a>
